...
void Engine::ToggleFullscreen()
{
    ...
    int width = XMLParser::Instance()->engineParams_.width;
    int height = XMLParser::Instance()->engineParams_.height;

    SDL_SetVideoMode(width, height, bits_, videoFlags_ | toggle);
